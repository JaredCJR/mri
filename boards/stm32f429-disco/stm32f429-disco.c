...
*/
/* Routines which expose STM32F429I specific functionality to the mri debugger. */
#include <string.h>
#include <platforms.h>
#include <try_catch.h>
#include "../../architectures/armv7-m/debug_cm3.h"
#include "../../devices/stm32f429xx/stm32f429xx_init.h"
#include "stm32f429i_asm.h"

#define FLAGS_MBED_DETECTED 1

#define STM32F429DISCO_UID_SIZE   36

typedef struct
{
    uint32_t flags;
    uint8_t  mbedUid[STM32F429DISCO_UID_SIZE];
} Stm32f429_discoState;

static Stm32f429_discoState g_state;
...
void Platform_Init(Token* pParameterTokens)
{
    ...
    __try
    {
        ...
        __throwing_func( __mriStm32f429xx_Init(pParameterTokens); );
    }
    __catch
    {
        __rethrow;
...
static void initModuleState(void)
{
    static const uint8_t  defaultMbedUid[STM32F429DISCO_UID_SIZE] = "101000000000000000000002F7F00000\0\0\0";
...
int __mriSTM32F429I_IsMbedDevice(void)
{
